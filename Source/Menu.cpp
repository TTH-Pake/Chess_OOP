...
Menu::Menu() { Setup("CHESS - OOP", sf::Vector2u(1280, 720)); }
...
void Menu::Textures() {
	...
	temp.loadFromFile("Assets/Textures/Menus/m_online.png");
	TextureMap["online"] = temp;
	...
	m_online.setTexture(TextureMap["online"]);

	newGame.Setup({ 220, 270 }, "Assets/Textures/Buttons/bb_play.png");
	online.Setup({ 670, 270 }, "Assets/Textures/Buttons/sb_board - Copy.png");
